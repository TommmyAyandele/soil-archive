  ...
  return (
    <div style={{ background: "#FBF6EC" }}>
          ...
          <div>
            ...
            {overview && (
              <div
                ...
                style={{ fontFamily: "var(--font-body)", fontSize: 18, lineHeight: 1.8, color: "#2A2A28" }}
      ...
      <style>{`
        ...
        .prose-archive strong { font-weight: 700; color: #1C1C1A; }
        ...
        .prose-archive blockquote { border-left: 3px solid #C9A84C; margin: 0 0 22px; padding-left: 20px; font-style: italic; color: #6B6B68; }
      `}</style>
    </div>
  );
}
